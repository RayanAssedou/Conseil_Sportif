    ...
    <div className="max-w-7xl mx-auto px-4 py-6 space-y-8">
      ...
      <div className="relative rounded-2xl overflow-hidden">
        ...
        <a
          ...
          className="absolute bottom-2 left-1/2 -translate-x-1/2 flex items-center gap-1.5 rounded-full bg-[#25D366] px-3 py-1 text-xs font-semibold text-white shadow-md shadow-black/25 ring-1 ring-white/25 transition-all hover:bg-[#1ebe5b] hover:scale-[1.03] active:scale-[0.98] whitespace-nowrap max-w-[calc(100%-1rem)]"
        >
