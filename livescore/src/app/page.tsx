  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-6 space-y-8">
      ...
      <section>
        ...
        {loadingFixtures ? (
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3">
            {[...Array(10)].map((_, i) => (
              <div key={i} className="bg-white rounded-xl border border-border p-3 animate-pulse">
            ...
            {previewMatches.map((fixture) => {
              ...
              return (
                <Link
                  ...
                  className={`relative bg-white rounded-xl border overflow-hidden p-3 transition-all duration-200 group hover:scale-[1.03] hover:shadow-lg hover:border-slate-300 ${
      ...
      <section>
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            {adminPredictions.length > 0 && (
              <span className="flex items-center gap-1 px-2 py-0.5 bg-amber-50 border border-amber-200 rounded text-xs font-bold text-amber-600">
        ...
        {!user ? (
          <div className="bg-gradient-to-br from-slate-50 to-white rounded-2xl border border-border p-10 md:p-14 flex flex-col items-center justify-center text-center">
            ...
            {predictionPreview.map((pred) => {
              ...
              return (
                <Link
                  ...
                  className="relative bg-white rounded-xl border border-border overflow-hidden p-3 transition-all duration-200 group hover:scale-[1.03] hover:shadow-lg hover:border-slate-300"
                >
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-1.5 min-w-0 flex-1">
                      {pred.home_logo && (
