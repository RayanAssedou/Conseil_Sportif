    ...
    <div className="max-w-7xl mx-auto px-4 py-6 space-y-8">
      ...
      <div className="flex justify-center">
        <a
          ...
          className="inline-flex items-center gap-2 rounded-full bg-[#25D366] px-5 py-2.5 text-sm sm:text-base font-bold text-white shadow-lg shadow-black/20 ring-1 ring-white/20 transition-all hover:bg-[#1ebe5b] hover:scale-[1.01] active:scale-[0.99] text-center"
        >
          ...
          <span>{t("home.joinHamalCommunity")}</span>
        </a>
      </div>
