          ...
          {plans.map((plan) => (
            ...
            >
              ...
              <a
                ...
                className={`flex items-center justify-center gap-2.5 w-full py-3.5 rounded-xl bg-gradient-to-r ${plan.btnGradient} ${plan.id === 3 ? "text-violet-700" : "text-white"} text-base font-bold shadow-lg transition-all hover:scale-[1.02] active:scale-[0.98]`}
              >
