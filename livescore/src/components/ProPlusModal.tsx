...
const plans: PlanConfig[] = [
  {
    ...
    gradient: "from-[#c6f526] to-[#a3d900]",
    btnGradient: "from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800",
  ...
  return (
    ...
    >
      ...
      >
        <button
          onClick={closeProPlus}
          className={`sticky top-3 z-20 w-9 h-9 rounded-full bg-white/10 backdrop-blur-md border border-white/20 flex items-center justify-center text-white hover:bg-white/20 transition-all ${isRtl ? "float-left ml-3" : "float-right mr-3"}`}
        >
        ...
        <div className="text-center pt-6 pb-4 px-6">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-500 to-blue-600 shadow-[0_0_30px_rgba(59,130,246,0.4)] mb-4">
          ...
          {plans.map((plan) => (
            <div
              ...
              className={`relative flex-1 rounded-2xl bg-gradient-to-br ${plan.gradient} p-6 flex flex-col shadow-xl ${
                plan.badge ? "ring-2 ring-white/30 lg:scale-[1.03]" : ""
              }`}
            >
              {/* Best value badge */}
              {plan.badge && (
