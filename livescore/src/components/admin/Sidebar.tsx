...
export default function Sidebar({ currentUser, onLogout, open, onClose }: SidebarProps) {
    ...
    <>
      ...
      >
        <div className="p-5 border-b border-slate-700/50 flex items-center justify-between">
          ...
          <button onClick={onClose} className="lg:hidden p-1 rounded hover:bg-slate-800 transition-colors">
        ...
        <nav className="flex-1 p-3 space-y-1 overflow-y-auto">
          <p className="px-3 pt-3 pb-2 text-[11px] font-semibold uppercase tracking-wider text-slate-500">Menu</p>
        ...
        <div className="p-4 border-t border-slate-700/50">
          <div className="flex items-center gap-3 mb-3">
            <div className="w-9 h-9 rounded-full bg-slate-700 flex items-center justify-center text-sm font-bold uppercase">
              {currentUser.charAt(0) || "A"}
            </div>
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium truncate">{currentUser || "Admin"}</p>
          ...
          <div className="flex gap-2">
            <Link
              href="/"
              className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 text-xs font-medium text-slate-300 bg-slate-800 rounded-lg hover:bg-slate-700 transition-colors"
            >
            ...
            <button
              onClick={onLogout}
              className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 text-xs font-medium text-red-300 bg-slate-800 rounded-lg hover:bg-red-600/20 transition-colors"
            >
              <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
